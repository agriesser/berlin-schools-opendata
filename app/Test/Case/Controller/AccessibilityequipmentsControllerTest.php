<?php
App::uses('AccessibilityequipmentsController', 'Controller');

/**
 * AccessibilityequipmentsController Test Case
 *
 */
class AccessibilityequipmentsControllerTest extends ControllerTestCase {
