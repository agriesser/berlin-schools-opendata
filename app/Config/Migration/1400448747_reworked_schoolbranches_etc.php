<?php
class ReworkedSchoolbranchesEtc extends CakeMigration {
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'advancedclasses_schoolbranches' => array(
					...
					'indexes' => array(
						'advancedclass_id' => array('column' => 'advancedclass_id', 'unique' => 0),
				...
				'schoolbranches_grades' => array(
					'schoolbranch_id' => array('type' => 'biginteger', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
					'grade_id' => array('type' => 'biginteger', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
					'indexes' => array(
						'PRIMARY' => array('column' => array('schoolbranch_id', 'grade_id'), 'unique' => 1),
				...
				'schools_specialactivities' => array(
					'schoolbranch_id' => array('type' => 'biginteger', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'index'),
					'specialactivity_id' => array('type' => 'biginteger', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
					'indexes' => array(
						'school_id' => array('column' => array('schoolbranch_id', 'specialactivity_id'), 'unique' => 0),
						'schoolbranch_id' => array('column' => 'schoolbranch_id', 'unique' => 0),
						'specialactivity_id' => array('column' => 'specialactivity_id', 'unique' => 0),
					),
					'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'InnoDB'),
				),
		...
		'down' => array(
			'drop_table' => array(
				'accessibilityequipments', 'addresses', 'advancedclasses', 'advancedclasses_schoolbranches', 'cooperations', 'districts', 'equipments', 'foreignlanguages', 'foreignlanguages_schoolbranches', 'grades', 'institutionproviders', 'jobtitles', 'partners', 'projectgroups', 'projectgroups_schoolbranches', 'schoolbranches', 'schoolbranches_grades', 'schoolbranchtype', 'schools', 'schools_accessibilityequipments', 'schools_equipments', 'schools_foreignlanguages', 'schools_specialactivities', 'schools_staffs', 'schools_subjects', 'schooltypes', 'specialactivities', 'staffs', 'subjects'
			),
		),
	);
